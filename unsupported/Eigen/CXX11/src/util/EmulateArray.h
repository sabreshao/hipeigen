...
#if (__cplusplus <= 199711L && EIGEN_COMP_MSVC < 1900) || defined(__HCC__) || defined(__NVCC__) || defined(EIGEN_AVOID_STL_ARRAY)
...
// The compiler supports c++11, and we're not targetting hip: use std::array as Eigen::array
#include <array>
namespace Eigen {
