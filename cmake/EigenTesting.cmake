...
macro(ei_add_test_internal testname testname_with_suffix)
 ...
 ## Explicit logic to look for cuda_basic file
  if(EIGEN_HIP_TEST_FILENAME STREQUAL "cuda_basic")
    set(HIPCC ${HIP_PATH}/bin/hipcc)
    set(CMAKE_CXX_COMPILER ${HIPCC} CACHE FILEPATH "CXX Compiler" FORCE)
     MESSAGE(STATUS "CMAKE_CXX_COMPILER USED" ${CMAKE_CXX_COMPILER})
  ...
  if(EIGEN_ADD_TEST_FILENAME_EXTENSION STREQUAL cu)
    ...
    if(NOT (EIGEN_HIP_TEST_FILENAME STREQUAL "cuda_basic"))
      add_executable(${targetname} ${filename})
    endif()
  endif()
